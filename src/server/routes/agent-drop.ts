...
export type DropImageType = 'image/png' | 'image/jpeg' | 'image/gif' | 'image/webp';

const EXT_BY_TYPE: Record<DropImageType, string> = {
  'image/png': '.png',
  'image/jpeg': '.jpg',
  'image/gif': '.gif',
  'image/webp': '.webp',
 ...
 * content-type, or null for anything outside the allow-list.
 */
