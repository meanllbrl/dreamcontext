...
If zero AUTHORITATIVE sources are found after triage, apply adaptive scoring (see `references/source-ranking.md` "Adaptive Scoring: No Authoritative Sources"). Flag this in the discovery report.
