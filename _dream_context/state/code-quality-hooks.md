...
- `agents/dreamcontext-rem-sleep.md` -- Step 1c pattern extraction
...
Inspired by ECC (everything-claude-code) competitive analysis. See `_dream_context/knowledge/competitive-analysis-ecc.md` for full analysis.
