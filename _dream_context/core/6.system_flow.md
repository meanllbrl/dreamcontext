...
name: System Flow
type: reference
summary: Session lifecycle, data flows, neuroscience mapping, and consolidation protocol; data-structures at knowledge/data-structures/; versioned migrations (registry+ledger) run on update/sleep start; SessionStart seeds taxonomy + injects setup-drift directive
updated: "2026-06-12"
---
