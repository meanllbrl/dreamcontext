...
| Data structures (single-product) | _dream_context/core/data-structures/default.md |
| Data structures (multi-product) | _dream_context/core/data-structures/<product>.md |
...
| Sleep specialists | .claude/agents/sleep-{tasks,state,product}.md |
