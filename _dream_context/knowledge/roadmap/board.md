...
> Auto-generated 2026-07-14 by `dreamcontext roadmap`. Objectives live in `core/objectives/`; task links live in each task's `objectives:` frontmatter.
...
### ⚪ **make-dreamcontext-team-ready** — Make Dreamcontext, Team Ready · 9/10 done (90%) · target 2026-07-12 · forecast 2026-07-12 ✓ on track
  ...
  - cloud-sync-stale-config-enabled-true-in-tree-mode-renders-dishonestly (todo)
...
### 🟡 **simplified-ux** — Simplified UX · 14/21 done (67%) · target 2026-07-31 · forecast 2026-07-31 ✓ on track
  Unblocks: hello-world-pr, make-it-a-business
