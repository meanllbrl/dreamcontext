...
> Auto-generated 2026-07-21 by `dreamcontext roadmap`. Objectives live in `core/objectives/`; task links live in each task's `objectives:` frontmatter.
...
### ⚪ **improve-recall-mechanism** — Improve Recall Mechanism · 4/5 done (80%) · target 2026-08-16 · forecast 2026-08-16 ✓ on track
  ...
  - feat-embedding-beta-rollout-opt-in-flag-doctor-gitignore-docs (todo) · 0.19.0
...
### 🟡 **simplified-ux** — Simplified UX · 19/26 done (73%) · target 2026-07-31 · forecast 2026-07-31 ✓ on track
  ...
  - author-a-task-via-a-claude-agent-from-the-new-task-button (in_review) · 0.19.0
  - changelog-json-and-releases-json-initialized-as-key-object-but-cli-requires-a-bare-array (todo) · 0.19.0
  - cloud-reliability-package-origin-setup-state-refresh-dependency-doctor-with-one-click-install-stop-api-key-self-deletion (in_review) · 0.19.0
  ...
  - feat-app-goal-skill-live-panel-above-the-agent-composer-sleepy-team-dock-chip (in_review) · 0.19.0
