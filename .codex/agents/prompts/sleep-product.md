...
| `dreamcontext knowledge create --tags "..."` | `core/objectives/*.md` (PO-authored roadmap objectives — never edit) |
| `dreamcontext features create <name>` | `knowledge/roadmap/board.md` (AUTO-GENERATED by `dreamcontext roadmap` — never hand-edit) |
