...
/** Hand a path to the OS and say whether it went — see `lib/reveal.ts`. Re-exported here
 *  because the transcript's file cards were its first caller and still import it from this
 *  module; it now also serves the export bars, which have no business importing chat. */
export { revealPath } from '../../../lib/reveal';
