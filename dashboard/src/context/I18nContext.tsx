...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'settings.vaults.title': 'Vaults',
    'settings.vaults.addHeading': 'Open a vault',
    'settings.vaults.openHint': 'Paste a project path (the name fills in automatically). After adding, open it with  dreamcontext dashboard --vault <name>  or the desktop app. Switching the active vault needs a relaunch.',
    'settings.vaults.empty': 'No vaults registered.',
    'settings.vaults.note': 'Switching vaults requires a relaunch. Desktop app required for auto-switch.',
    'settings.vaults.current': 'Current',
    'settings.vaults.add': 'Add Vault',
    'settings.vaults.namePlaceholder': 'Vault name',
    'settings.vaults.pathPlaceholder': 'Absolute path to project',
    'settings.vaults.addButton': 'Add',
    'settings.vaults.adding': 'Adding...',
