...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'settings.cloud_tasks.label': 'Cloud Task Management (ClickUp)',
    'settings.cloud_tasks.hint': 'Tasks live in a ClickUp list; a gitignored local mirror keeps recall, snapshots, and the dashboard working unchanged.',
    'settings.cloud_tasks.team': 'Team ID',
    'settings.cloud_tasks.space': 'Space ID',
    'settings.cloud_tasks.list': 'List ID',
    'settings.cloud_tasks.token_hint': 'The API key is CLI-managed: run `dreamcontext config clickup-token` (stored in a gitignored secrets file, never in this config).',
