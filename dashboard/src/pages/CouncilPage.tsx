...
import { CreateDebateModal } from '../components/council/CreateDebateModal';
...
export function CouncilPage() {
  ...
  return (
    <div className="council-page">
      <CouncilHall debates={debates ?? []} onOpen={setOpenId} onNew={() => setCreating(true)} />

      {creating && <CreateDebateModal onClose={() => setCreating(false)} />}
    </div>
  );
}
