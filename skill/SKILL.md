...
| **Web dashboard** | Local React UI: Kanban, Eisenhower matrix, brain graph, sleep tracker, council hall, in-app Claude Code agent (terminal; **Chat view BETA** — native markdown/tool/question cards, same engine) | [integrations.md](references/integrations.md) |
